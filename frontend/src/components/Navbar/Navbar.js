  ...
  if (auth) {
    buttons = (
      <>
        ...
        <Link
          className="btn btn-light action-button rounded-0"
          role="button"
          to="/favourites"
        >
          Favorites
        ...
        <Link className="btn btn-light action-button rounded-0" role="button" to="/cart">
          Cart
        </Link>
        <Link
          className="btn btn-light action-button rounded-0"
  ...
  return (
    <>
      <nav className="navbar navbar-light navbar-expand-lg navigation-clean-search">
        <div className="container" style={{backgroundColor:"#FDEBD2"} }>
