        ...
        <div className="row">
          <div className="col-lg-12 p-5 bg-white rounded shadow-sm mb-5">
            {items.length > 0 ? (
              ...
              <>
                <h1 style={{color: "#691348"}}>Oops!! nothing to view</h1>
                <p style={{color: "#691348"}}>you can view  purchase history</p>
                <Link
                  to="/purchased"
        ...
        {items.length > 0 ? (
          <div className="row bg-white rounded shadow-sm">
            <div className="col-lg-6 p-5 bg-white rounded shadow-sm offset-6">
              <div className="bg rounded-pill px-4 py-3 text-uppercase font-weight-bold">
              Order summary
              </div>
              <div className="p-4">
